      ...
      >
        ...
        <div className="space-y-2">
          <p className="text-sm text-amber-400 leading-relaxed">
            Рекомендация основана на официальных каталогах брендов по состоянию на Июль 2026. Всегда проверяйте актуальную сервисную книжку автомобиля и консультируйтесь с официальным сервисом. Я не заменяю профессиональную диагностику.
          </p>
